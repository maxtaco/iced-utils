...
(function() {
  var err, fs, iced, mkdir_p, path, rm_rf, __iced_deferrals, __iced_k, __iced_k_noop;
  ...
  exports.rm_rf = rm_rf = function(d, cb) {
                          ...
                          (function(__iced_k) {
                            if (stat.isDirectory()) {
                              (function(__iced_k) {
                                ...
                                rm_rf(full, __iced_deferrals.defer({
                                  assign_fn: (function() {
                                    return function() {
                                      return err = arguments[0];
                                    };
...
_break()
  ...
  rm_rf(process.argv[2], __iced_deferrals.defer({
